...
(function($, window) {
     ...
     */
    $.LoadingOverlaySetup({
        image: "/static/kosmo/assets/img/loaders/svg-loaders/three-dots.svg",
        /*image       : "",
    ...
    window.Kosmo = {
        ...
        initSidebarScrollBar: function(ksSidebar, isSidebarFixed) {
            if (isSidebarFixed) {
                $(document).find('.ks-sidebar .ks-sidebar-wrapper').jScrollPane({
    ...
    $(document).ready(function() {
        ...
        $('.ks-sidebar-style-checkbox-toggle :checkbox').on('change', function () {
            if (this.checked) {
                $('html head').append('<link class="ks-sidebar-dark-style" rel="stylesheet" type="text/css" href="/static/kosmo/assets/styles/themes/sidebar-black.min.css">');
            } else {
