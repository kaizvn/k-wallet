          ...
          <div class="content">
            <div class="left-content">
               <div class="row-left-content">
                <span class="label">type:</span> <span style="color:${typeColor};" class="bold-text"> ${typeString} </span>
                <span class="float-right"><span class="label">coin: </span>${coin}</span>
              </div>
              <div class="row-left-content">
                <span class="label">receiver:</span> ${receiver}
              </div>
              <div class="row-left-content">
            ...
            <div class="right-content">
              <div class="border-content margin-content">
                ...
                <span class="label float-right">amount</span>
              </div>
              <div class="border-content margin-content">
                <div>
                  <span>Amount </span>
