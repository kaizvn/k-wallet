...
const enhance = compose(connectToRedux, withTranslation('admin-page-layout'));
...
const HeaderUserInfoComponent = ({ user, logout, isAdmin, t }) => {
      ...
      >
        <div className={classes.accountName}>
          ...
          <Typography variant="body2" display="block" gutterBottom>
            {isAdmin ? t('options.administrator') : t('options.moderator')}
          </Typography>
        </div>
        <Divider />
        ...
        <RLink href="/changepassword">
          <MenuItem className={classes.menuItem} onClick={handleClose}>
            <VpnKey fontSize="small" /> <div>&nbsp;&nbsp;</div>{' '}
            {t('options.change_password')}
          </MenuItem>
        </RLink>
        <RLink href="/settings">
          <MenuItem className={classes.menuItem} onClick={handleClose}>
