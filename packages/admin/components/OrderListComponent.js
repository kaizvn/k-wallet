...
import {
  setOrderDeliveredByAdmin,
  setOrderRevertedByAdmin
...
const connectToRedux = connect(
  ...
  dispatch => ({
    ...
    setDoneOrdered: id => dispatch(setOrderDeliveredByAdmin(id)),
    setDoneReverted: id => dispatch(setOrderRevertedByAdmin(id))
  })
);
