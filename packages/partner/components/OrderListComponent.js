...
import {
  setOrderDeliveredByPartner,
  setOrderRevertedByPartner
...
const connectToRedux = connect(
  ...
  dispatch => ({
    ...
    setDoneOrdered: id => dispatch(setOrderDeliveredByPartner(id)),
    setDoneReverted: id => dispatch(setOrderRevertedByPartner(id))
  })
);
