...
const PartnerUsersPage = ({ t, ...rootProps }) => (
  <PartnerPageLayout {...rootProps} title={t('page_header.member.user')}>
    <div> underconstruction </div>
  </PartnerPageLayout>
);

PartnerUsersPage.getInitialProps = async () => ({
  namespacesRequired: ['partner-page-layout']
});

export default enhance(PartnerUsersPage);
